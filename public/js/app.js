...
__webpack_require__(/*! ./negoprice */ "./resources/js/negoprice.js");
  ...
  if (Number(actionshow) <= priceshow.value * centshow.value / 100) {
    ...
    if (count > 0) {
      if (Number(actionshow) <= last) {
        ...
        yesorno.style.display = "flex"; //  ////////////loader/////////////
        ...
        if (cvs.getContext) {
          ...
          setTimeout(function () {
            ...
            loader.style.display = "none"; ///////decrementation compteur//////
...
__webpack_require__(/*! /home/popschool/lara6demo/NegodevisV2/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/popschool/lara6demo/NegodevisV2/resources/sass/app.scss */"./resources/sass/app.scss");
